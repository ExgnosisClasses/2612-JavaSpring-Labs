...
You can use the last version of the SPA from Lab 4-8 as the starting point. There are some modifications necessary to add the new operations as specified in the SPA supplement.
